<script>
  ...
  async function handleImageUpload(event) {
    ...
    if (file) {
      featuredImage = await uploadAsset(file, 'articles/' + file.name); // Update path as necessary
    }
  }
  console.log('hi',featuredImage);
</script>
  ...
  <div class="max-w-screen-md mx-auto ">
      <div class="flex flex-wrap gap-3 items-center text-[15px]">
          <div class="flex flex-wrap gap-3"><a
                  ...
                  href="../category/life%20lessons.html">life lessons</a></div>
          <div class="text-sm data-color flex items-center "><span class="whitespace-nowrap "> {#if !published_at}
            DRAFT
          {:else}
           {formatDate(published_at)}
          {/if}</span><span class="px-2.5">⋅</span><span class="whitespace-nowrap">4 min read</span>
          </div>
      </div>
      <h2 class="font-bold leading-snug text-3xl sm:text-[2.5rem] mt-6">  <PlainText bind:content={title} /></h2>
      <div class="flex gap-2 items-center mt-4">
          <div class="flex"><a class="flex -ml-3 first:ml-0 first:z-10 hover:z-20 "
                  href="../author/brook.html">
                  <div class="rounded-full overflow-hidden  border-gray-200 dark:border-gray-700 inline-block leading-[0] !border-2"
                      style="width:30px;height:30px">
                      <div class="pt-[100%] relative"><img alt="author avatar" sizes="30px"
          ...
          <div><a class="text-sm font-medium heading-color" href="../author/brook.html">Brook Jerald</a></div>
      </div>
    ...
    {/if}
      <div
          class="prose sm:prose-lg max-w-none dark:prose-invert prose-figcaption:text-sm prose-figcaption:text-center prose-figcaption:mt-2 mt-16" id="article_content">
          <RichText multiLine bind:content />
      </div>
      <div class="flex flex-wrap gap-3 mt-16"><a
              class="text-xs font-semibold data-color rounded-full capitalize bg-gray-100 py-2 px-3 dark:bg-zinc-900 whitespace-nowrap"
              href="../tag/life%20lessons.html">life lessons</a><a
              class="text-xs font-semibold data-color rounded-full capitalize bg-gray-100 py-2 px-3 dark:bg-zinc-900 whitespace-nowrap"
              href="../tag/mental%20health.html">mental health</a><a
              class="text-xs font-semibold data-color rounded-full capitalize bg-gray-100 py-2 px-3 dark:bg-zinc-900 whitespace-nowrap"
              href="../tag/art.html">art</a><a
              class="text-xs font-semibold data-color rounded-full capitalize bg-gray-100 py-2 px-3 dark:bg-zinc-900 whitespace-nowrap"
              href="../tag/featured.html">featured</a></div>
      <div class="flex items-center mt-16"><span
              class="font-semibold mr-4 text-sm uppercase data-color">Share:</span>
          <div class="flex gap-4"><a
                  ...
                  target="_blank" rel="noreferrer" aria-label="Twitter share button"><svg
                  ...
                  target="_blank" rel="noreferrer" aria-label="Facebook share button"><svg
                  ...
                  target="_blank" rel="noreferrer" aria-label="LinkedIn share button"><svg
