<script>
	...
	import contactBg from "$lib/img/contactPageBg.webp";
...
<div class="container-fluid py-20 sm:py-24 md:py-32 lg:py-40 bg-fixed bg-cover cover relative contactPage z-10" style="background: url({contactBg}) center center no-repeat;">
	<div class="container mx-auto px-4">
		<div class="flex flex-col md:flex-row">
			<div class="md:w-1/2 p-4">
				<div class="contactInfo">
					<div class="email contactInfoInner">
						<i>
					...
					<div class="phone contactInfoInner">
						<i>
						...
						<div>
							<p>Phone</p>
							<a href="tel:123456789">(123) 456-6789</a>
						</div>
					</div>
					<div class="address contactInfoInner">
						<i>
						...
						<div>
							<p>Address</p>
							<span>Duis elementum ex fermentum
								Molestie eros et, ultricies lacus</span>
						</div>
					</div>
				</div>
			</div>
