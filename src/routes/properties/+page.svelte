...
<div class="container-fuid propertiesPage pt-20 lg:pt-32">
	<div class="container mx-auto">
		<div class="flex-1 md:col-span-2 mb-4 md:mb-0">
			<h2 class="listingsHeading text-start">Idar "small-title" class use kro, consistency bro...</h2>
		</div>
		<form class="w-full mx-auto md:w-full px-6">
			<!-- Search Bar -->
			<div class="mb-4">
			...
			<div class="flex mb-4 my-4">
				<div class="w-1/3 pr-2">
						...
						<Select placeholder="Property Type" class="mt-2" items={propertyTypes} bind:value={selectedType} />				 
				
				</div>
				<div class="w-1/3 px-2">
					<Select placeholder="Bedrooms" class="mt-2" items={bedroomOptions} bind:value={selectedBedRoom} />
				</div>
				<div class="w-1/3 pl-2">
					<Select placeholder="Bathrooms" class="mt-2" items={bathroomOptions} bind:value={selectedBathRoom} />					
				</div>
			</div>
...
<Range  id="living-area" min="1" max="5" bind:value={livingAreaValue} size="sm" step="0.2"/>
...
<div class="container-fluid listingsSec img-100 py-14 md:py-16">
	<div class="container mx-auto">
		<div class="flex flex-wrap">
			<div class="w-full md:w-1/2 lg:w-1/3 2xl:w-1/4 px-4 mb-8">
